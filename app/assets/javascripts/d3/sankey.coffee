    ...
    refinery:
      data:
        nodes: [
          ...
          {id: 'non_refinery_products_input',     column: 0, label: 'non_refinery_products_input',  color: '#ff7f0e'}
          ...
          {id: 'synthetic_production',            column: 1, label: 'synthetic_production',   color: '#BFEFFF'},
          ...
          {id: 'loss',                            column: 2},
          {id: 'non_refinery_products_output',    column: 2, label: 'non_refinery_products_output',   color: '#ff7f0e'},
        ...
        links: [
          ...
          {left: 'oil_import',                             right: 'refinery',                          gquery: 'crude_oil_import_to_industry_transformation_refineries_in_sankey', color: '#854321'},
          {left: 'extraction',                             right: 'refinery',                          gquery: 'crude_oil_extraction_to_refinery_in_sankey', color: '#854321'},
          {left: 'extraction',                             right: 'refinery',                          gquery: 'crude_oil_extraction_to_industry_transformation_refineries_in_sankey', color: '#854321'},
          {left: 'heat_input',                             right: 'refinery',                          gquery: 'refinery_heat_input_in_sankey', color: '#d62728'},
          {left: 'heat_input',                             right: 'refinery',                          gquery: 'industry_transformation_refineries_heat_input_in_sankey', color: '#d62728'},
          {left: 'non_refinery_products_input',            right: 'refinery',                          gquery: 'non_refinery_products_to_industry_transformation_refineries_in_sankey', color: '#ff7f0e'},
          ...
          {left: 'refinery',                               right: 'distribution_diesel',               gquery: 'diesel_industry_transformation_refineries_to_distribution_in_sankey', color: '#854321'},
          {left: 'refinery',                               right: 'distribution_gasoline',             gquery: 'gasoline_industry_transformation_refineries_to_distribution_in_sankey', color: '#8B0000'},
          {left: 'refinery',                               right: 'distribution_lpg',                  gquery: 'lpg_industry_transformation_refineries_to_distribution_in_sankey', color: '#CCCCCC'},
          {left: 'refinery',                               right: 'distribution_hfo',                  gquery: 'hfo_industry_transformation_refineries_to_distribution_in_sankey', color: '#BA7D40'},
          {left: 'refinery',                               right: 'distribution_kerosene',             gquery: 'kerosene_industry_transformation_refineries_to_distribution_in_sankey', color: '#BFEFFF'},
          {left: 'refinery',                               right: 'distribution_oil_products',         gquery: 'oil_products_industry_transformation_refineries_to_distribution_in_sankey', color: '#854321'},
          {left: 'refinery',                               right: 'non_refinery_products_output',      gquery: 'industry_transformation_refineries_to_non_refinery_products_in_sankey', color: '#ff7f0e'},
