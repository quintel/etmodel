D3.sankey =
  data :
    nodes: [
      ...
      {id: 'heat',   column: 1, label: "heat production", color: '#d62728'},
    ...
    links: [
      ...
      {left: 'geo_solar_wind_water_ambient',      right: 'chps', gquery: 'geo_solar_wind_water_ambient_to_chps_prod_in_sankey', color: 'black'},
      ...
      {left: 'geo_solar_wind_water_ambient',      right: 'households', gquery: 'geo_solar_wind_water_ambient_to_households_in_sankey', color: 'black'},
      {left: 'geo_solar_wind_water_ambient',      right: 'buildings', gquery: 'geo_solar_wind_water_ambient_to_buildings_in_sankey', color: 'black'},
      {left: 'geo_solar_wind_water_ambient',      right: 'agriculture', gquery: 'geo_solar_wind_water_ambient_to_agriculture_in_sankey', color: 'black'},
      {left: 'geo_solar_wind_water_ambient',      right: 'transport', gquery: 'geo_solar_wind_water_ambient_to_transport_in_sankey', color: 'black'},
      {left: 'geo_solar_wind_water_ambient',      right: 'industry', gquery: 'geo_solar_wind_water_ambient_to_industry_in_sankey', color: 'black'},
      {left: 'geo_solar_wind_water_ambient',      right: 'other', gquery: 'geo_solar_wind_water_ambient_to_other_in_sankey', color: 'black'},
      ...
      {left: 'electricity_prod',      right: 'loss', gquery: 'electricity_prod_to_loss_in_sankey', color: '#1f77b4'},
      {left: 'heat',      right: 'loss', gquery: 'heat_to_loss_in_sankey', color: '#d62728'},
      {left: 'chps',      right: 'loss', gquery: 'chps_to_loss_in_sankey', color: '#d62728'},
    ]
