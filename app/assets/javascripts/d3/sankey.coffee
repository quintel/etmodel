    ...
    sankey_heat_networks:
      data:
        ...
        links: [
          ...
          {left: 'mt_network',                   right: 'households',           gquery: 'mt_network_to_final_demand_households_in_sankey_heat_networks',      color: '#FFD700'},
          ...
          {left: 'lt_network',                   right: 'households',           gquery: 'lt_network_to_final_demand_households_in_sankey_heat_networks',      color: '#FFD700'},
