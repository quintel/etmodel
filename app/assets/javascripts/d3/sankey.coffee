    ...
    sankey_heat_networks:
      data:
        ...
        links: [
          ...
          {left: 'ht_network',                   right: 'households',           gquery: 'ht_network_to_final_demand_households_in_sankey_heat_networks',      color: '#4169E1'},
          ...
          {left: 'mt_network',                   right: 'agriculture',          gquery: 'mt_network_to_final_demand_agriculture_in_sankey_heat_networks',     color: '#FFD700'},
          {left: 'mt_network',                   right: 'buildings',            gquery: 'mt_network_to_final_demand_buildings_in_sankey_heat_networks',       color: '#ADD8E6'},
          {left: 'mt_network',                   right: 'bunkers',              gquery: 'mt_network_to_final_demand_bunkers_in_sankey_heat_networks',         color: '#8B4513'},
          {left: 'mt_network',                   right: 'energy',               gquery: 'mt_network_to_final_demand_energy_in_sankey_heat_networks',          color: '#416B86'},
          {left: 'mt_network',                   right: 'households',           gquery: 'mt_network_to_final_demand_households_in_sankey_heat_networks',      color: '#4169E1'},
          {left: 'mt_network',                   right: 'industry',             gquery: 'mt_network_to_final_demand_industry_in_sankey_heat_networks',        color: '#A9A9A9'},
          {left: 'mt_network',                   right: 'other',                gquery: 'mt_network_to_final_demand_other_in_sankey_heat_networks',           color: '#E07033'},
          {left: 'mt_network',                   right: 'transport',            gquery: 'mt_network_to_final_demand_transport_in_sankey_heat_networks',       color: '#8B0000'},
          ...
          {left: 'lt_network',                   right: 'agriculture',          gquery: 'lt_network_to_final_demand_agriculture_in_sankey_heat_networks',     color: '#FFD700'},
          {left: 'lt_network',                   right: 'buildings',            gquery: 'lt_network_to_final_demand_buildings_in_sankey_heat_networks',       color: '#ADD8E6'},
          {left: 'lt_network',                   right: 'bunkers',              gquery: 'lt_network_to_final_demand_bunkers_in_sankey_heat_networks',         color: '#8B4513'},
          {left: 'lt_network',                   right: 'energy',               gquery: 'lt_network_to_final_demand_energy_in_sankey_heat_networks',          color: '#416B86'},
          {left: 'lt_network',                   right: 'households',           gquery: 'lt_network_to_final_demand_households_in_sankey_heat_networks',      color: '#4169E1'},
          {left: 'lt_network',                   right: 'industry',             gquery: 'lt_network_to_final_demand_industry_in_sankey_heat_networks',        color: '#A9A9A9'},
          {left: 'lt_network',                   right: 'other',                gquery: 'lt_network_to_final_demand_other_in_sankey_heat_networks',           color: '#E07033'},
          {left: 'lt_network',                   right: 'transport',            gquery: 'lt_network_to_final_demand_transport_in_sankey_heat_networks',       color: '#8B0000'},
