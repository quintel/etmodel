    ...
    refinery:
      data:
        nodes: [
          ...
          {id: 'industry_transformation',         column: 1, label: 'industry_transformation',               color: '#43464B'}, 
        ...
        links: [
          ...
          {left: 'oil_import',                    right: 'industry_transformation',  gquery: 'crude_oil_import_to_industry_transformation_in_sankey', color: '#854321'},
          {left: 'extraction',                    right: 'refinery',                 gquery: 'crude_oil_extraction_to_refinery_in_sankey', color: '#854321'},
          {left: 'extraction',                    right: 'industry_transformation',  gquery: 'crude_oil_extraction_to_industry_transformation_in_sankey', color: '#854321'},
          {left: 'heat_input',                    right: 'refinery',                 gquery: 'refinery_heat_input_in_sankey', color: '#d62728'},
          {left: 'heat_input',                    right: 'industry_transformation',  gquery: 'industry_transformation_heat_input_in_sankey', color: '#d62728'},
          {left: 'non_refinery_products_input',   right: 'industry_transformation',  gquery: 'non_refinery_products_to_industry_transformation_in_sankey', color: '#ff7f0e'},
          ...
          {left: 'industry_transformation',       right: 'distribution_diesel',      gquery: 'diesel_industry_transformation_to_distribution_in_sankey', color: '#854321'},
          {left: 'industry_transformation',       right: 'distribution_gasoline',    gquery: 'gasoline_industry_transformation_to_distribution_in_sankey', color: '#8B0000'},
          {left: 'industry_transformation',       right: 'distribution_lpg',         gquery: 'lpg_industry_transformation_to_distribution_in_sankey', color: '#CCCCCC'},
          {left: 'industry_transformation',       right: 'distribution_hfo',         gquery: 'hfo_industry_transformation_to_distribution_in_sankey', color: '#BA7D40'},
          {left: 'industry_transformation',       right: 'distribution_kerosene',    gquery: 'kerosene_industry_transformation_to_distribution_in_sankey', color: '#BFEFFF'},
          {left: 'industry_transformation',       right: 'distribution_oil_products',gquery: 'oil_products_industry_transformation_to_distribution_in_sankey', color: '#854321'},
          {left: 'industry_transformation',       right: 'loss',                     gquery: 'industry_transformation_loss_in_sankey', color: '#416B86'},
          {left: 'industry_transformation',       right: 'non_refinery_products_output',    gquery: 'industry_transformation_to_non_refinery_products_in_sankey', color: '#ff7f0e'},
