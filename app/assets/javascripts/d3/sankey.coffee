D3.sankey =
  data :
    ...
    links: [
      ...
      {left: 'heat',      right: 'households', gquery: 'heat_to_households_in_sankey', color: 'blue'},
      {left: 'distribution',      right: 'households', gquery: 'distribution_to_households_in_sankey', color: 'blue'},
      {left: 'electricity_prod',      right: 'buildings', gquery: 'electricity_prod_to_buildings_in_sankey', color: 'blue'},
      {left: 'heat',      right: 'buildings', gquery: 'heat_to_buildings_in_sankey', color: 'blue'},
      {left: 'distribution',      right: 'buildings', gquery: 'distribution_to_buildings_in_sankey', color: 'blue'},
      {left: 'electricity_prod',      right: 'agriculture', gquery: 'electricity_prod_to_agriculture_in_sankey', color: 'blue'},
      {left: 'heat',      right: 'agriculture', gquery: 'heat_to_agriculture_in_sankey', color: 'blue'},
      {left: 'distribution',      right: 'agriculture', gquery: 'distribution_to_agriculture_in_sankey', color: 'blue'},
      {left: 'electricity_prod',      right: 'transport', gquery: 'electricity_prod_to_transport_in_sankey', color: 'blue'},
      {left: 'heat',      right: 'transport', gquery: 'heat_to_transport_in_sankey', color: 'blue'},
      {left: 'distribution',      right: 'transport', gquery: 'distribution_to_transport_in_sankey', color: 'blue'},
      {left: 'electricity_prod',      right: 'industry', gquery: 'electricity_prod_to_industry_in_sankey', color: 'blue'},
      {left: 'heat',      right: 'industry', gquery: 'heat_to_industry_in_sankey', color: 'blue'},
      {left: 'distribution',      right: 'industry', gquery: 'distribution_to_industry_in_sankey', color: 'blue'},
      {left: 'electricity_prod',      right: 'other', gquery: 'electricity_prod_to_other_in_sankey', color: 'blue'},
      {left: 'heat',      right: 'other', gquery: 'heat_to_other_in_sankey', color: 'blue'},
      {left: 'distribution',      right: 'other', gquery: 'distribution_to_other_in_sankey', color: 'blue'},
