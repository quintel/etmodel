...
EstablishmentShot.Main = (function() {
  ...
  Main.prototype = {
    render: function () {
      EstablishmentShot.Charts.setNonEnergetic(EstablishmentShot.non_energetic);
  ...
  function Main(scope) {
    ...
    EstablishmentShot.non_energetic = true;
    // EstablishmentShot.non_energetic = data.non_energetic;
  }
