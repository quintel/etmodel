...
class @PlantProfitabilityTableView extends HtmlTableChartView
  ...
  series_labels:
    ...
    energy_power_wood_pellets_dispatchable: 'wood_pellets_power'
    energy_power_wood_pellets_ccs_dispatchable: 'wood_pellets_power_ccs'
    energy_chp_local_ht_wood_pellets_dispatchable: 'wood_pellets_chp_ht'
    energy_chp_local_mt_wood_pellets_dispatchable: 'wood_pellets_chp_mt'
    energy_chp_local_ht_wood_pellets_ccs_dispatchable: 'wood_pellets_chp_ht_ccs'
    energy_chp_local_mt_wood_pellets_ccs_dispatchable: 'wood_pellets_chp_mt_ccs'
