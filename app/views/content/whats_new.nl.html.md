    ...
    <p>
      <details>
        <summary><u>Wat betekent dit voor bestaande scenario's?</u></summary>
          Bestaande scenario's voor Nederlandse gemeentes, provincies of RES-regio's hebben nu 2019 als startjaar. Als er geen actie wordt ondernomen, worden deze scenario's automatisch bijgewerkt naar de 2023 datasets, die gebaseerd zijn op recente en kwalitatief betere data. Let op: de resultaten van deze scenario's zullen veranderen door de update naar 2023. Als veranderingen in scenarioresultaten onwenselijk zijn, kunnen ze worden overgezet naar de stabiele versie <code>#2025-01</code> <b>voor oktober</b>. Zie de <a href="https://docs.energytransitionmodel.com/main/user_manual/model-versions#move-scenarios-between-versions" target="_blank">documentatie</a> voor meer informatie over modelversies of <a href="https://my.energytransitionmodel.com/contact" target="_blank">neem contact op</a> bij vragen. Scenario's die voor Nederland zijn gemaakt met startjaar 2019 zullen niet veranderen, aangezien deze dataset behouden blijft.
      </details>
    </p>
  </ul>
</div>
