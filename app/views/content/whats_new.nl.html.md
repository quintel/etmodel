...
<details>
  ...
  * Consistentie ontbrak in hoe het input- en outputvermogen van opslagtechnologieën waren gedefinieerd. Specifiek bij <a href="https://energytransitionmodel.com/scenario/flexibility/flexibility_storage/large-scale-batteries" target="_blank">grootschalige batterijen</a> en <a href="https://energytransitionmodel.com/scenario/flexibility/flexibility_storage/flow-batteries" target="_blank">flowbatterijen</a> was het outputvermogen niet gelijk aan het inputvermogen, wat het soms bemoeilijkte om het gewenste gedrag van deze batterijen te modelleren. Dit is nu verholpen door voor deze technologieën het outputvermogen gelijk te stellen aan het inputvermogen, zoals dit ook bij de andere opslagtechnologieën het geval is. Als gevolg hiervan kan het opgestelde outputvermogen van dit type batterijen enigszins veranderd zijn in bestaande scenario's.
