...
<details>
  ...
  * Het aanpassen van de <a href="https://energytransitionmodel.com/scenario/flexibility/flexibility_weather/extreme-weather-conditions" target="_blank">vollasturen</a> resulteerde soms in inconsistente energiestromen bij de zonnecentrale PV voor H2 en de windturbine op zee voor H2, tussen de component voor elektriciteitsproductie en de component voor waterstofproductie. Dit is verholpen zodat de stromen tussen deze componenten consistent zijn.
  * Door een bug in de instellingen voor <a href="https://energytransitionmodel.com/scenario/flexibility/flexibility_net_load/curtailment-solar-pv" target="_blank">productiebeperking</a> van zon-PV kon het voorkomen dat de zon-PV technologieën een hoger piekvermogen hadden dan volgens deze instellingen was toegestaan. Dit probleem is verholpen.
  * Door een bug in de <a href="https://energytransitionmodel.com/scenario/flexibility/flexibility_weather/extreme-weather-conditions" target="_blank">weerjarenset</a> (alleen voor Nederlandse regio's) werd de uurlijkse warmtevraag in huishoudens niet aangepast wanneer een ander weerjaar werd gekozen. Dit is  verholpen.
