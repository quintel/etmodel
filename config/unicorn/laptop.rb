worker_processes 2
working_directory '/Users/admin/Sites/etmodel'
...
listen '/Users/admin/Sites/etmodel/tmp/unicorn.sock', backlog: 64

# File containing the Unicorn process ID.
pid '/Users/admin/Sites/etmodel/tmp/unicorn.pid'

# Set the path of the log files inside the log folder of the testapp
stderr_path '/Users/admin/Sites/etmodel/log/unicorn.log'
stdout_path '/Users/admin/Sites/etmodel/log/unicorn.log'
...
before_fork do |server, worker|
  ...
  # end the old process...
  old_pid = '/Users/admin/Sites/etmodel/tmp/unicorn.pid.oldbin'
