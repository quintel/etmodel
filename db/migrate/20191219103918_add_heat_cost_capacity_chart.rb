class AddHeatCostCapacityChart < ActiveRecord::Migration[5.2]
  ...
  COLORS = {
    'energy_heat_backup_burner_network_gas_heat_cost_capacity_chart' => '#A4B0BE',
    'energy_heat_burner_coal_heat_cost_capacity_chart' => '#FFA500',
    'energy_heat_burner_crude_oil_heat_cost_capacity_chart' => '#ADD8E6',
    'energy_heat_burner_hydrogen_heat_cost_capacity_chart' => '#CD6133',
    'energy_heat_burner_network_gas_heat_cost_capacity_chart' => '#333333',
    ...
    'energy_heat_heatpump_water_water_electricity_heat_cost_capacity_chart' => '#CED6E0',
    'energy_heat_network_storage_heat_cost_capacity_chart' => '#FFA502'
  }
