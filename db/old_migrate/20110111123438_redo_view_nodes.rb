class RedoViewNodes < ActiveRecord::Migration
  def self.up
    {
      'advanced' => 3, # name => complexity
          ...
          if slides.present?
            ...
            slides.each do |slide|
              ...
              slide.input_elements.max_complexity( complexity ).each do |input_element|
                ...
                node = InputElementNode.create :element => input_element, :parent => slide_node
              end
              if slide.default_output_element_id
