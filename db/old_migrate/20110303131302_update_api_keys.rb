class UpdateApiKeys < ActiveRecord::Migration
  def self.up
    ...
    execute "UPDATE input_elements SET `key` = 'transport_useful_demand_car_kms_electric_share' WHERE `id` = 146;"
    execute "UPDATE input_elements SET `key` = 'transport_useful_demand_car_kms_diesel_share' WHERE `id` = 147;"
    execute "UPDATE input_elements SET `key` = 'transport_useful_demand_car_kms_gasoline_share' WHERE `id` = 148;"
    ...
    execute "UPDATE input_elements SET `key` = 'transport_useful_demand_car_kms_lpg_share' WHERE `id` = 238;"
    execute "UPDATE input_elements SET `key` = 'transport_useful_demand_car_kms_compressed_gas_share' WHERE `id` = 239;"
    ...
    execute "UPDATE input_elements SET `key` = 'number_of_energy_power_ultra_supercritical_coal_ccs' WHERE `id` = 251;"
