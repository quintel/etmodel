...
var fdSliderController = (function() {
        ...
        var init = function( elem ) {
                var ranges     = /fd_range_([-]{0,1}[0-9]+(d[0-9]+){0,1}){1}_([-]{0,1}[0-9]+(d[0-9]+){0,1}){1}/i,
                    ...
                    callbacks  = /((fd_slider_cb_(click|update|create|destroy|redraw|move|focus|blur|enable|disable)_)([^\s|$]+))/ig, 
        ...
        function fdSlider(options) {
                var inp         = options.inp,
                    disabled    = false,
                    visibleButDisabled = options.visibleButDisabled,
                ...
                function disableVisibleButDisabled() {
                ...
                return {
                        ...
                        disableVisibleButDisabled: function()  { disableVisibleButDisabled(); }
                };
        }; 
        ...
        return {                          
                        ...
                        disableVisibleButDisabled:  function(id) { if(!(id in sliders)) { return false; }; sliders[id].disableVisibleButDisabled(); }
        }
})();             
